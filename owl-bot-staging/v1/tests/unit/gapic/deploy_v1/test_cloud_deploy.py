...
from google.cloud.deploy_v1.services.cloud_deploy.transports.base import _GOOGLE_AUTH_VERSION
...
def test_cloud_deploy_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_create_delivery_pipeline_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].delivery_pipeline == cloud_deploy.DeliveryPipeline(name='name_value')
