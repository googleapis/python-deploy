...
class CloudDeployRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_abandon_release(self, response: cloud_deploy.AbandonReleaseResponse) -> cloud_deploy.AbandonReleaseResponse:
        ...
        """
        return response
    def pre_advance_rollout(self, request: cloud_deploy.AdvanceRolloutRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_deploy.AdvanceRolloutRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_approve_rollout(self, response: cloud_deploy.ApproveRolloutResponse) -> cloud_deploy.ApproveRolloutResponse:
        ...
        """
        return response
    def pre_cancel_rollout(self, request: cloud_deploy.CancelRolloutRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_deploy.CancelRolloutRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_target(self, response: cloud_deploy.Target) -> cloud_deploy.Target:
        ...
        """
        return response
    def pre_ignore_job(self, request: cloud_deploy.IgnoreJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_deploy.IgnoreJobRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_retry_job(self, response: cloud_deploy.RetryJobResponse) -> cloud_deploy.RetryJobResponse:
        ...
        """
        return response
    def pre_terminate_job_run(self, request: cloud_deploy.TerminateJobRunRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_deploy.TerminateJobRunRequest, Sequence[Tuple[str, str]]]:
...
class CloudDeployRestTransport(CloudDeployTransport):
    ...
    @property
    def advance_rollout(self) -> Callable[
    ...
    @property
    def cancel_rollout(self) -> Callable[
    ...
    @property
    def terminate_job_run(self) -> Callable[
